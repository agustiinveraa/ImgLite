...
function Home() {
  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center gap-8 p-2 md:p-0">
        ...
        <div className="w-full max-w-4xl mx-auto min-h-96 rounded-lg mb-20">
          <div className="flex flex-col justify-center text-center gap-4">
            <div id="form" className="text-5xl font-bold text-center">
              Optimize your image here:{" "}
            </div>
            <div className="text-lg">
              Optimize and compress your images effortlessly to boost
              performance. Completely free!
              <span className="text-gray-300 text-sm italic"> Up to 10 mb</span>
            </div>
          </div>
          <br />
          <Form />
